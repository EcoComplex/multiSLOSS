...
```{r SLOSS_lambda14_simulations,echo=FALSE,message=FALSE,warning=FALSE,fig.align='center',eval=TRUE}

# pf = probability of fragmentation, hps = habitat patch size , dd=dispersal distance 
# hps = habitat patch size
# dd = dispersal distance 
# brb = bird rate birds 
nl@experiment <- experiment(expname="NoSelection_pf06_hps3-61_dd1-3_brb1-4",
                            outpath=outpath,
                            repetition=1,
                            tickmetrics="false",
                            idsetup="setup",
...
```{r ExploratoryPlots, echo=FALSE,message=FALSE,warning=FALSE,fig.align='center',eval=FALSE}

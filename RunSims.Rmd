...
## Read Simulations No Selection Random Block Patterns prob-frag = 0.6
...
```{r Hierarchical_SLOSS_lambda14_pf48_simulations_regular,echo=FALSE,message=FALSE,warning=FALSE,eval=TRUE}

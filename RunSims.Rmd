...
ggsave("Figures/Species_Habitat_Dispersal_Lambda_pf_regular.png",width=8,height=6,units="in",dpi=600)
...
ggsave("Figures/Shannon_Habitat_Dispersal_Lambda_pf_regular.png",width=8,height=6,units="in",dpi=600)
...
ggsave("Figures/Shannon_MeanPatch_Dispersal_Lambda_regular.png",width=8,height=6,units="in",dpi=600)
...
```{r SLOSS_lambda14_pf48_block,echo=FALSE,message=FALSE,warning=FALSE,fig.align='center',eval=TRUE}
...
nl@experiment <- experiment(expname="Hierarchical_pf04-08_hps3-61_dd1-3_brb1-4_regular",
                            ...
                            variables = list("birds-dispersal-distance" = list(values=c(1.1, 1.2, 1.5, 2, 3)),
                                              "habitat-patch-size" = list(values=c(3, 9, 29, 61)),
                                               "birth-rate-birds" = list(values=c(1.7, 2, 3, 4)),
                                             "prob-frag" =  list(values=c(0.4,0.8))
                                             ),
                            constants = list("world-width" = 199,
                                             "world-height" = 199,
                                             "initial-population" = 0,
...
ggsave("Figures/Hierarchical_Species_Dispersal_pf_Lambda_regular.png",width=8,height=6,units="in",dpi=600)
...
ggsave("Figures/Hierarchical_Shannon_Dispersal_pf_Lambda_regular.png",width=8,height=6,units="in",dpi=600)
...
ggsave("Figures/Hierarchical_Species_Dispersal_pf_Lambda_block.png",width=8,height=6,units="in",dpi=600)
...
ggsave("Figures/Hierarchical_Shannon_Dispersal_pf_Lambda_block.png",width=8,height=6,units="in",dpi=600)
...
## Simulations Lambda = 1-4 / Regular patterns - Birth Selection communities / prog frag 0.4-0.8

```{r Selection_SLOSS_lambda14_pf48_regular,echo=FALSE,message=FALSE,warning=FALSE,eval=FALSE}
...
```{r Selection_SLOSS_lambda14_pf48_block,echo=FALSE,message=FALSE,warning=FALSE,eval=FALSE}
...
ggsave("Figures/Selection_Species_Dispersal_Lambda_pf_regular.png",width=8,height=6,units="in",dpi=600)
...
ggsave("Figures/Selection_Shannon_Dispersal_Lambda_pf_regular.png",width=8,height=6,units="in",dpi=600)
...
ggsave("Figures/Selection_Species_Dispersal_Lambda_pf_block.png",width=8,height=6,units="in",dpi=600)
...
ggsave("Figures/Selection_Shannon_Dispersal_Lambda_pf_block.png",width=8,height=6,units="in",dpi=600)
...
image_paths <- c("Figures/NoSelection_lambda2_dd15_ps3_before_nsp37.png","Figures/NoSelection_lambda2_dd15_ps3_after_nsp32.png","Figures/NoSelection_lambda2_dd15_ps3_after_lt_nsp3.png",
                 "Figures/NoSelection_lambda2_dd15_ps29_ before_nsp36.png","Figures/NoSelection_lambda2_dd15_ps29_ after_nsp29.png","Figures/NoSelection_lambda2_dd15_ps29_ after_lt_nsp25.png")
